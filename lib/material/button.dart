...
class FrostedCloseButton extends StatefulWidget {
  const FrostedCloseButton(this.onPressed);

  final VoidCallback onPressed;

  @override
  FrostedCloseButtonState createState() {
    return FrostedCloseButtonState();
  }
}
